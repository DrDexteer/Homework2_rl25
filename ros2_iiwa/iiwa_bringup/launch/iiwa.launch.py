...
def generate_launch_description():
    ...
    set_gz_res  = SetEnvironmentVariable(name='GZ_SIM_RESOURCE_PATH',  value=[models_path, ':', worlds_path])
    # Ignition (Fortress)
    set_ign_res = SetEnvironmentVariable(name='IGN_GAZEBO_RESOURCE_PATH', value=[models_path, ':', worlds_path])
